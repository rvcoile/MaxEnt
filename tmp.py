...
samples_rAlpha=10**4# number of LHS samples Alpha - PHASE ONE - fixed Alpha values

number_best_phase2=100 # number of best values considered for PHASE TWO
...
xmax_default=200. # # extremely import variable if you move away from the LN testcase

xmax_printing=200. # range for calc CDF and PDF -- make sure this is a float!!!!
x_deltaprint=1.
...
if SW_Debug==False:
	...
	for m in mlist:
		...
		phase_one(m, samples_rAlpha, RandomField_Eval, W, xmax_default)
		...
		if SW_Testing:
			...
			# Testing LN variable
			mean_LN=46.8; cov_LN=0.467401326
